...
const setView = (gl, shader, transformationMat) => {
...
const drawBunny = (gl, shader, buffers, pointLightPosition, spotLightPosition) => {
...
const render = (then, now, theta, transformationMat, lastPosition) => {
    ...
    drawBunny(gl, shader, buffers, pointLightPosition, spotLightPosition)
